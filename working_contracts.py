...
DICT_CONTRACTS = {
    ...
    '01-09-01/811 от 31.10.2018': 'Хоум Кредит энд Финанс Банк 01-09-01/811 от 31.10.2018',  # ХОУМ КРЕДИТ
    '02-21-01/21/1663 от 28.12.2021': '02-21-01/21/1663 ГПБ (обработка) от 28.12.2021',  # ГПБ
    '': '',  #
    '': '',  #
}
